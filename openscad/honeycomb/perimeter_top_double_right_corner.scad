...
module perimeter_top_item(corner_item=false) {
  ...
  translate([-r_outer*0, 3*h_outer, 0])
     panel_with_clips(pin_4=true, pin_5=true, pin_3=!corner_item, slot_3=corner_item); 
...
module perimeter_bottom() {
    ...
    perimeter_top_item(corner_item=true);
  ...
  perimeter_left_item(pin_5=true, pin_6=true);
